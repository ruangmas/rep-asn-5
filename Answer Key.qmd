...
![](equation.png){fig-align="center" width="500"}
...
Remove all lines of script with **#\| eval: false** which prevents the line from running when rendered. Afterward, click Render to generate an html file of this document. Click **Render** to generate an html file of this document.
